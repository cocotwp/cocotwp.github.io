...
泛化误差受到模型的结构（复杂度）影响，两者关系如下图所示：:smile:

<div align="center">
	<img src="https://raw.githubusercontent.com/cocotwp/cocotwp.github.io/master/assets/images/决策树/泛化误差和模型复杂度的关系.png" alt="泛化误差和模型复杂度的关系" width="50%"/>
</div>
